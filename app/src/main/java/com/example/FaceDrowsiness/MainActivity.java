package com.example.FaceDrowsiness;
...
import com.example.FaceDrowsiness.image.ImageClassificationActivity;
import com.example.FaceDrowsiness.object.DrowsinessDetectionActivity;
...
public class MainActivity extends AppCompatActivity implements AlgoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Algo(R.drawable.baseline_time_to_leave_black_48, "Детектор сонливості", DrowsinessDetectionActivity.class));
